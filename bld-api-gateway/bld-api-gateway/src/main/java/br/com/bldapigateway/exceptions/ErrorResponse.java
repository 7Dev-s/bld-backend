...
public class ErrorResponse {
	...
	@Singular
	private List<br.com.bldapigateway.exceptions.ErrorData> errors;
	...
	public ErrorResponse(String statusCode, String type, String message) {
		final br.com.bldapigateway.exceptions.ErrorData errorData = br.com.bldapigateway.exceptions.ErrorData.builder().type(type).message(message).build();
